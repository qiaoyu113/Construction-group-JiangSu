            ...
            <el-row :gutter="20">
                            ...
                            <el-form-item prop="cId" label="合同id">
                                <el-input v-model="dataForm.cId"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="grantStarttime" label="授权期限-开始时间">
                                <el-input v-model="dataForm.grantStarttime"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
                            <el-form-item prop="grantEndtime" label="授权期限-结束时间">
                            ...
                            <el-form-item prop="result" label="审核结果">
                                <el-input v-model="dataForm.result"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="approvalStatus" label="审核状态（字典表）">
    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pId: '',                                                                                                                                                            cId: '',                                                                                                                                                            grantStarttime: '',                                                                                                                                                            grantEndtime: '',                                                                                                                                                            grantUser: '',                                                                                                                                                            grantContent: '',                                                                                                                                                            remark: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
