            ...
            <el-row :gutter="20">
                            ...
                            <el-form-item prop="cId" label="合同id：">
                                <el-input v-model="dataForm.cId"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="expendType" label="本次收款类型（字典表）：">
                                <el-input v-model="dataForm.expendType"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
                            <el-form-item prop="expendStype" label="本次收款子类型（字典表）：">
                            ...
                            <el-form-item prop="amount" label="本次付款金额：">
                                <el-input v-model="dataForm.amount"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="expendDate" label="实际支出日期：">
                                <el-input v-model="dataForm.expendDate"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pId: '',                                                                                                                                                            cId: '',                                                                                                                                                            expendType: '',                                                                                                                                                            expendStype: '',                                                                                                                                                            amount: '',                                                                                                                                                            expendDate: '',                                                                                                                                                            remark: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
                                ...
                                { required: true, message: '合同id不能为空', trigger: 'blur' }
                                                                                                                                                            ...
                                                                                                                                                            expendType: [
                                { required: true, message: '本次收款类型（字典表）不能为空', trigger: 'blur' }
                            ],
                                                                                                                                                            expendStype: [
                                { required: true, message: '本次收款子类型（字典表）不能为空', trigger: 'blur' }
                            ],
                                                                                                                                                            amount: [
                                { required: true, message: '本次付款金额不能为空', trigger: 'blur' }
                            ],
                                                                                                                                                            expendDate: [
                                { required: true, message: '实际支出日期不能为空', trigger: 'blur' }
                            ],
                                                                                                                                                            remark: [
