            ...
            <el-row :gutter="20">
                            ...
                            <el-form-item prop="pmId" label="项目经理唯一标识id">
                                <el-input v-model="dataForm.pmId"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="constructorLevel" label="建造师等级（字典表）">
    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    pmId: '',                                                                                                                                                            constructorLevel: '',                                                                                                                                                            constructorCode: '',                                                                                                                                                            safeB: '',                                                                                                                                                            remark: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    pmId: [
