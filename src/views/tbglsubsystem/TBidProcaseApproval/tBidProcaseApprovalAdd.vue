        ...
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item prop="proIntroduce" label="项目简介：">
              <t-input type="textarea" :rows="4" v-model="dataForm.proIntroduce" :readOnly="readOnly"></t-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item prop="proAddressDetail" label="详细地址：" display="t">
              <el-input v-model="dataForm.proAddressDetail" :readOnly="readOnly"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item prop="contactNum" label="联系方式：">
              <el-input v-model="dataForm.contactNum" :readOnly="readOnly"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
