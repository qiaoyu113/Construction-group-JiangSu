            ...
            <el-row :gutter="20">
                            ...
                            <el-form-item prop="pcId" label="项目备案id">
                                <el-input v-model="dataForm.pcId"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="keyId" label="密钥id">
                                <el-input v-model="dataForm.keyId"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
                            <el-form-item prop="proSubCompany" label="该项目所属分公司">
    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pcId: '',                                                                                                                                                            keyId: '',                                                                                                                                                            proSubCompany: '',                                                                                                                                                            useScenes: '',                                                                                                                                                            limitStarttime: '',                                                                                                                                                            limitEnditme: '',                                                                                                                                                            getTime: '',                                                                                                                                                            returnTime: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
