<template>
  <div>
    ...
    <el-row v-if="showButton" :gutter="10" class="search-top-operate">
      <el-button type="primary" icon="el-icon-s-check" @click="submitDialogVisible = true">
        提交审批
      </el-button>
      ...
      <el-dialog title="审批流程图" :visible.sync="dialogVisible" width="70%">
        <!-- businessKey值请修改当前流程的key值 -->
        <t-workflow-map businessKey="t_bid_file_approval_process"></t-workflow-map>
        <div slot="footer">
        ...
        <el-row :gutter="20">
          <el-col :span="17">
            <el-form-item prop="bidFileType" label="文件类型">
              <t-dic-radio-select dicType="file_type" v-model="dataForm.bidFileType"
