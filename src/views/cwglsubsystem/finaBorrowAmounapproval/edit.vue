      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item prop="totalBorrowCount" label="累计借款次数">
            <el-input v-model="dataForm.totalBorrowCount"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item prop="realAmount" label="确认借款额度">
            <el-input v-model="dataForm.realAmount"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item prop="borrowDate" label="借款日期">
            <el-input v-model="dataForm.borrowDate"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
  ...
  export default {
    data () {
      return {
        ...
        docId: '',
        dataForm: {
          bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pId: '',                                                                                                                                                            applyAmount: '',                                                                                                                                                            tiimeLimit: '',                                                                                                                                                            totalBorrowCount: '',                                                                                                                                                            totalBorrowAmount: '',                                                                                                                                                            realAmount: '',                                                                                                                                                            borrowDate: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
        dataRule: {
          bId: [
