      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="文件类型">
            <el-input @submit.native.prevent @keyup.enter.native="doRefresh()"
                      v-model="gridOptions.dataSource.serviceInstanceInputParameters.processFileType" placeholder="文件类型"
                      clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
  ...
  export default {
    ...
    data () {
      return {
        ...
        gridOptions: {
          dataSource: {
            serviceInstance: tapp.services.proProcessFileApproval.getPagedList,
