  ...
  <div>
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="ruleForm" @submit.native.prevent @keyup.enter.native="doSave()"
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item prop="prcId" label="经营方式变更主键">
            <el-input v-model="dataForm.prcId"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item prop="conPorjectFund" label="最终结算工程款">
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          prcId: [
            {required: true, message: '经营方式变更主键不能为空', trigger: 'blur'}
          ],
          pId: [
