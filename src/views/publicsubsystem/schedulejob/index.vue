...
<div class="mod-role">
  <div style="float:left;">
   ...
   <div style="float:right;">
    ...
    <el-form-item>
     <el-input style="width:150px;" prefix-icon="el-icon-search"  v-model="gridOptions.dataSource.serviceInstanceInputParameters.searchKey" placeholder="名称" clearable></el-input>
    </el-form-item>
    <el-form-item>
          ...
          columns: [{
            ...
            },
            {
              ...
              render: (h, params) => {
                return h('el-tag', {
                  props: {
                    type: params.row.lastLogResult === 'error' ? 'danger' : 'success'
                  } // 组件的props
