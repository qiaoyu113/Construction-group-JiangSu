...
<div>
  <el-row :gutter="20">
  <el-col :span="9">
     <el-button  type="primary" icon="el-icon-download" @click="doDownloadLoanDataTemplate()">下载借款数据模板文件</el-button>
    </el-col>
  </el-row>
...
export default {
  ...
  methods: {
    doDownloadLoanDataTemplate() {
      window.open(window.SITE_CONFIG['serverUrl'] + '/authapi/pl_loandoc/generateLoanExportDataTemplate',"_blank");
    },
    getFileId() {
