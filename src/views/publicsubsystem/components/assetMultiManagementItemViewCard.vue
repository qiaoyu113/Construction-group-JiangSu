...
export default {
  ...
  methods: {
    ...
    getFileUrl(file) {
      return window.SITE_CONFIG['serverUrl'] + "/pmtapi/base_AssetManagement/view?tb=1&id=" + file.id;
    },
    getFileDownloadUrl(file) {
      return window.SITE_CONFIG['serverUrl'] + "/pmtapi/base_AssetManagement/download?id=" + file.id;
    },
    getFileType(file) {
