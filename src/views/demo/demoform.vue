	...
	<div>
		<el-tabs v-model="tabActive" @tab-click="handleTabClick" tab-position="right" class="fixed-header">
			<el-tab-pane label="客户资料" name="baseInfo">
				<el-form :model="docEntity" ref="ruleForm" @submit.native.prevent @keyup.enter.native="doSave()" label-width="160px">
					<el-row :gutter="20">
						<el-col :span="24">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="身份证-性别" prop="customerCardNOSexId" verify class="is-required">
								<t-dic-dropdown-select dicType="public_sex" v-model="docEntity.customerCardNOSexId" :readOnly="readOnly"></t-dic-dropdown-select>
							</el-form-item>
						</el-col>
						<el-col :span="12">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="人员弹出选择" prop="trackingPersonInfoMRId" verify :maxLength="50" class="is-required">
								<base-user-select role-category="base_rolecategory_trackingpersoninfomr" v-model="docEntity.trackingPersonInfoMRId"
								 :text="docEntity.trackingPersonInfoMRName" placeholder="请选择" :readOnly="readOnly">
								</base-user-select>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="人员弹出多选" prop="trackingPersonInfoMRIdsList" verify class="is-required">
								<base-user-multi-select role-category="base_rolecategory_trackingpersoninfomr" v-model="docEntity.trackingPersonInfoMRIdsList"
					...
					<el-row :gutter="20">
						...
						<el-col :span="12">
							<el-form-item label="婚姻状况-下拉-多选" prop="maritalStatusIdList" verify class="is-required">
								<t-dic-dropdown-select dicType="public_maritalstatus" :multiple="true" v-model="docEntity.maritalStatusIdList"
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="多图片上传">
								<base-asset-image-management ref="assetManagement" assetCategory="image" :businessDocId="docId" list-type="picture-card">
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="单图片上传">
								<base-asset-image-management ref="assetManagement" assetCategory="image2" :businessDocId="docId" list-type="picture-card"
								 :limit="1">
								</base-asset-image-management>
							</el-form-item>
						</el-col>
							...
							<t-edit-grid ref="customerRelationGrid" :options="customerRelationGridOptions" :readOnly="readOnly">
								<template slot="columnDataHeader">
									...
									<t-edit-grid-column prop="trackingPersonInfoMRId" label="人员弹出选择" verify min-width="160" class-name="is-required">
										<template slot-scope="scope">
											<base-user-select role-category="base_rolecategory_trackingpersoninfomr" v-model="scope.row.trackingPersonInfoMRId"
											 :text="scope.row.trackingPersonInfoMRName" placeholder="请选择" :readOnly="readOnly">
											</base-user-select>
										</template>
									</t-edit-grid-column>
									...
									<t-edit-grid-column prop="maritalStatusIdList" label="婚姻状况-下拉-多选" verify min-width="160" class-name="is-required">
										<template slot-scope="scope">
											<t-dic-dropdown-select dicType="public_maritalstatus" :multiple="true" v-model="scope.row.maritalStatusIdList"
											 :readOnly="readOnly"></t-dic-dropdown-select>
										</template>
									</t-edit-grid-column>
									...
									<t-edit-grid-column prop="educationalLevelIdList" label="学历-复选" verify min-width="160" class-name="is-required">
										<template slot-scope="scope">
											<t-dic-checkbox-select dicType="public_educationallevel" class="el-checkbox-group-vertical" v-model="scope.row.educationalLevelIdList"
									...
									<t-edit-grid-column prop="jobId" label="职务-radio" verify min-width="160" class-name="is-required">
										<template slot-scope="scope">
											<t-dic-radio-select dicType="pl_loanenter_job" class="el-radio-group-vertical" v-model="scope.row.jobId"
			...
			<el-tab-pane label="附件" name="assetManagement">
				<div style="margin-bottom:20px;">
					<base-asset-multi-management ref="assetManagement" :assetCategoryClassifications="assetCategoryClassifications"
			...
			<el-col :span="24">
				<div class="t-form-footer">
					<div style="float:left">
						<base-export-template :templateUrl="exportTemplateUrl" :templateCategoryId="'base_exporttemplate_pl_contract'"
						 :title="'打印'" :docId="docId"></base-export-template>
					</div>
