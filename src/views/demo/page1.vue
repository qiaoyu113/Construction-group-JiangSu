          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="项目选择" prop="projectId">
                <t-project-select placeholder="选择一个项目" v-model="dataForm.projectId"
                                  @selectedProject="getSelectedProject"></t-project-select>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="经办人" prop="userId">
                <t-handler-select label="经办人" placeholder="选择一个经办人" v-model="dataForm.userId"
                                  @selectedUser="getSelectedUser"></t-handler-select>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="联营公司名称" prop="companyId">
                <t-partner-select placeholder="选择一个联营公司" v-model="dataForm.companyId"
                                  @selectedPartner="getSelectedPartner"></t-partner-select>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="主要负责人" prop="mainPid">
                <t-maincharge-select placeholder="选择一个主要负责人" v-model="dataForm.mainPid"
                                     @selectedMainCharge="getSelectedMainCharge"></t-maincharge-select>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="备案项目" prop="recordId">
                <t-record-select placeholder="选择一个备案项目" v-model="dataForm.recordId"
                                 @selectedRecord="getSelectedRecord"></t-record-select>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="项目经理" prop="managerId">
                <t-manager-select placeholder="选择一个项目经理" v-model="dataForm.managerId"
