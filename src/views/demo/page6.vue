        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="人员弹出多选" prop="trackingPersonInfoMRIdsList" verify  class="is-required">
              <base-user-multi-select role-category="base_rolecategory_trackingpersoninfomr" v-model="docEntity.trackingPersonInfoMRIdsList"  placeholder="请选择" :readOnly="readOnly">
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="单图片上传">
              <base-asset-image-management ref="assetManagement" assetCategory="image2" :businessDocId="docId" list-type="picture-card" :limit="1">
              </base-asset-image-management>
            </el-form-item>
          </el-col>
        </el-row>
