    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pcId: '',                                                                                                                                                            pId: '',                                                                                                                                                            remark: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
        ...
        methods: {
            ...
            init (id) {
                if(id) {
                    ...
                    this.$nextTick(() => {
                        ...
                        if (this.dataForm.id) {
                            tapp.services.bidPletterApproval.get(id).then(function(result) {
                                self.$util.deepObjectAssign({}, self.dataForm, result)
                                                                                                                                                                                this.dataForm.bId = result.bidPletterApproval.bId
                                                                                                                                                this.dataForm.actTaskKey = result.bidPletterApproval.actTaskKey
                                                                                                                                                this.dataForm.pcId = result.bidPletterApproval.pcId
                                                                                                                                                this.dataForm.pId = result.bidPletterApproval.pId
                                                                                                                                                this.dataForm.remark = result.bidPletterApproval.remark
                                                                                                                                                this.dataForm.sign = result.bidPletterApproval.sign
                                                                                                                                                this.dataForm.signTime = result.bidPletterApproval.signTime
                                                                                                                                                this.dataForm.approvalStatus = result.bidPletterApproval.approvalStatus
                                                                                                                                                this.dataForm.propose = result.bidPletterApproval.propose
                                                                                                                                                this.dataForm.result = result.bidPletterApproval.result
                                                                                                                                                this.dataForm.createtime = result.bidPletterApproval.createtime
                                                                                                                                                this.dataForm.updatetime = result.bidPletterApproval.updatetime
                                                                                                                                                this.dataForm.createuser = result.bidPletterApproval.createuser
                                                                                                                                                this.dataForm.updateuser = result.bidPletterApproval.updateuser
                                                                                                                                                this.dataForm.datastatus = result.bidPletterApproval.datastatus
                                                                                                })
                        }
                    })
                } else {
            ...
            doSave () {
                ...
                Promise.all(validPromises).then(resultList => {
                    ...
                    tapp.services.bidPletterApproval.save(model).then(function(result) {
