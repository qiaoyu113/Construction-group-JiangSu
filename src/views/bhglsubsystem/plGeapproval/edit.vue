          ...
          this.$nextTick(() => {
            ...
            if (this.dataForm.id) {
              ...
              tapp.services.plGeapproval.get(id).then(function(result) {
                ...
                self.dataForm.pId = result.plGeapproval.pId
                self.dataForm.plId = result.plGeapproval.plId
                self.dataForm.remark = result.plGeapproval.remark
                self.dataForm.sign = result.plGeapproval.sign
                self.dataForm.signTime = result.plGeapproval.signTime
                self.dataForm.propose = result.plGeapproval.propose
                self.dataForm.result = result.plGeapproval.result
                self.dataForm.approvalStatus = result.plGeapproval.approvalStatus
                self.dataForm.createtime = result.plGeapproval.createtime
                self.dataForm.updatetime = result.plGeapproval.updatetime
                self.dataForm.createuser = result.plGeapproval.createuser
              })
            }
          })
        } else {
