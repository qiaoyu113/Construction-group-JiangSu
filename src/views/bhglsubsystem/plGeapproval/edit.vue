          ...
          this.$nextTick(() => {
            ...
            if (this.dataForm.id) {
              tapp.services.plGeapproval.get(id).then(function(result) {
                ...
                this.dataForm.bId = result.plGeapproval.bId
                this.dataForm.actTaskKey = result.plGeapproval.actTaskKey
                this.dataForm.pId = result.plGeapproval.pId
                this.dataForm.plId = result.plGeapproval.plId
                this.dataForm.remark = result.plGeapproval.remark
                this.dataForm.sign = result.plGeapproval.sign
                this.dataForm.signTime = result.plGeapproval.signTime
                this.dataForm.propose = result.plGeapproval.propose
                this.dataForm.result = result.plGeapproval.result
                this.dataForm.approvalStatus = result.plGeapproval.approvalStatus
                this.dataForm.createtime = result.plGeapproval.createtime
                this.dataForm.updatetime = result.plGeapproval.updatetime
                this.dataForm.createuser = result.plGeapproval.createuser
                this.dataForm.updateuser = result.plGeapproval.updateuser
                this.dataForm.datastatus = result.plGeapproval.datastatus
              })
            }
          })
        } else {
