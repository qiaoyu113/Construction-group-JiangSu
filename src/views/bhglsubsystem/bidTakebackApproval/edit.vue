            ...
            <el-row :gutter="20">
                            ...
                            <el-form-item prop="pcId" label="项目备案id">
                                <el-input v-model="dataForm.pcId"></el-input>
                                                                                ...
                                                                                <el-col :span="8">
                            <el-form-item prop="pId" label="投标保证金（保函）申请id">
                                <el-input v-model="dataForm.pId"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
                            <el-form-item prop="prId" label="投标保证金（保函）退回id">
                                <el-input v-model="dataForm.prId"></el-input>
                            </el-form-item>
                        </el-col>
                                                                                <el-col :span="8">
    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pcId: '',                                                                                                                                                            pId: '',                                                                                                                                                            prId: '',                                                                                                                                                            remark: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
        ...
        methods: {
            ...
            init (id) {
                if(id) {
                    ...
                    this.$nextTick(() => {
                        ...
                        if (this.dataForm.id) {
                            tapp.services.bidTakebackApproval.get(id).then(function(result) {
                                self.$util.deepObjectAssign({}, self.dataForm, result)
                                                                                                                                                                                this.dataForm.bId = result.bidTakebackApproval.bId
                                                                                                                                                this.dataForm.actTaskKey = result.bidTakebackApproval.actTaskKey
                                                                                                                                                this.dataForm.pcId = result.bidTakebackApproval.pcId
                                                                                                                                                this.dataForm.pId = result.bidTakebackApproval.pId
                                                                                                                                                this.dataForm.prId = result.bidTakebackApproval.prId
                                                                                                                                                this.dataForm.remark = result.bidTakebackApproval.remark
                                                                                                                                                this.dataForm.sign = result.bidTakebackApproval.sign
                                                                                                                                                this.dataForm.signTime = result.bidTakebackApproval.signTime
                                                                                                                                                this.dataForm.approvalStatus = result.bidTakebackApproval.approvalStatus
                                                                                                                                                this.dataForm.propose = result.bidTakebackApproval.propose
                                                                                                                                                this.dataForm.result = result.bidTakebackApproval.result
                                                                                                                                                this.dataForm.createtime = result.bidTakebackApproval.createtime
                                                                                                                                                this.dataForm.updatetime = result.bidTakebackApproval.updatetime
                                                                                                                                                this.dataForm.createuser = result.bidTakebackApproval.createuser
                                                                                                                                                this.dataForm.updateuser = result.bidTakebackApproval.updateuser
                                                                                                                                                this.dataForm.datastatus = result.bidTakebackApproval.datastatus
                                                                                                })
                        }
                    })
                } else {
            ...
            doSave () {
                ...
                Promise.all(validPromises).then(resultList => {
                    ...
                    tapp.services.bidTakebackApproval.save(model).then(function(result) {
