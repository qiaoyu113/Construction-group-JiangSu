    ...
    export default {
        data () {
            return {
                ...
                docId: '',
                dataForm: {
                                                                                                                                                    bId: '',                                                                                                                                                            actTaskKey: '',                                                                                                                                                            pcId: '',                                                                                                                                                            pId: '',                                                                                                                                                            returnDate: '',                                                                                                                                                            remark: '',                                                                                                                                                            sign: '',                                                                                                                                                            signTime: '',                                                                                                                                                            approvalStatus: '',                                                                                                                                                            propose: '',                                                                                                                                                            result: '',                                                                                                                                                            createtime: '',                                                                                                                                                            updatetime: '',                                                                                                                                                            createuser: '',                                                                                                                                                            updateuser: '',                                                                                                                                                            datastatus: ''                                                                                        },
                dataRule: {
                                                                                                                                                    bId: [
        ...
        methods: {
            ...
            init (id) {
                if(id) {
                    ...
                    this.$nextTick(() => {
                        ...
                        if (this.dataForm.id) {
                            tapp.services.bidPreturnApproval.get(id).then(function(result) {
                                self.$util.deepObjectAssign({}, self.dataForm, result)
                                                                                                                                                                                this.dataForm.bId = result.bidPreturnApproval.bId
                                                                                                                                                this.dataForm.actTaskKey = result.bidPreturnApproval.actTaskKey
                                                                                                                                                this.dataForm.pcId = result.bidPreturnApproval.pcId
                                                                                                                                                this.dataForm.pId = result.bidPreturnApproval.pId
                                                                                                                                                this.dataForm.returnDate = result.bidPreturnApproval.returnDate
                                                                                                                                                this.dataForm.remark = result.bidPreturnApproval.remark
                                                                                                                                                this.dataForm.sign = result.bidPreturnApproval.sign
                                                                                                                                                this.dataForm.signTime = result.bidPreturnApproval.signTime
                                                                                                                                                this.dataForm.approvalStatus = result.bidPreturnApproval.approvalStatus
                                                                                                                                                this.dataForm.propose = result.bidPreturnApproval.propose
                                                                                                                                                this.dataForm.result = result.bidPreturnApproval.result
                                                                                                                                                this.dataForm.createtime = result.bidPreturnApproval.createtime
                                                                                                                                                this.dataForm.updatetime = result.bidPreturnApproval.updatetime
                                                                                                                                                this.dataForm.createuser = result.bidPreturnApproval.createuser
                                                                                                                                                this.dataForm.updateuser = result.bidPreturnApproval.updateuser
                                                                                                                                                this.dataForm.datastatus = result.bidPreturnApproval.datastatus
                                                                                                })
                        }
                    })
                } else {
            ...
            doSave () {
                ...
                Promise.all(validPromises).then(resultList => {
                    ...
                    tapp.services.bidPreturnApproval.save(model).then(function(result) {
