<template>
  <div class="widget-form-container">
    ...
    <el-form ref="ruleForm" :label-position="data.config.labelPosition" :label-width="data.config.labelWidth + 'px'">
          ...
          <template v-if="element.type == 'grid'">
            <div v-if="element && element.key"  class="widget-grid-container data-grid" :key="element.key" style="position: relative;">
              <el-row class="widget-grid "
                :class="{active: selectWidget && element && selectWidget.key == element.key}"
                :gutter="element.options.gutter ? element.options.gutter : 20"
              ...
              <el-button title="删除" style="bottom: -20px;" @click.stop="handleWidgetDelete(index)" class="widget-action-delete" v-if="selectWidget && element && selectWidget.key == element.key" circle plain type="danger">
