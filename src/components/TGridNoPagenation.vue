<template>
<div>
  <t-table-no-pagenation ref="mutipleTable" :options="gridOptions" :maxHeight="tableMaxHeight" :empty-text="emptyText" :data="data" :total="total" :current-page-index="currentPageIndex" @size-change="handleSizeChange" @current-change="handleIndexChange" @cell-click="handleCellClick" @selection-change="handleSelectionChange"
  ...
  </t-table-no-pagenation>
</div>
</template>
<script>
import TTableNoPagenation from './TTableNoPagenation.vue'
