<template>
<el-dialog :close-on-click-modal="false" :visible.sync="visible" :fullscreen="true" :append-to-body="true">
  <div slot="title">
    <el-row>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    ...
    download() {
      ...
      return window.SITE_CONFIG['serverUrl'] + "/pmtapi/base_AssetManagement/download?id=" + this.viewer.id;
    },
  ...
  methods: {
    ...
    loadFile() {
      ...
      this.url = window.SITE_CONFIG['serverUrl'] + "/pmtapi/base_AssetManagement/view?id=" + this.viewer.id;
    },
